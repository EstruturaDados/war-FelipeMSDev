...
// --- Constantes Globais ---
#define MAX_TERRITORIOS 5 // Definem valores fixos para o número de territórios, missões e tamanho máximo de strings, facilitando a manutenção.
...
int main() {
    ...
    territorio continentes[MAX_TERRITORIOS];
